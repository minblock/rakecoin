...
{
    const char* pszTimestamp = "4/20/2020 Provigen.etworks: Now accepting crackkingarinos";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586067113, 2436499, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbfa823cca31017afb231ed58cdd00f0eba3363214909fd8c4aea07434eb3ff9b"));
        assert(genesis.hashMerkleRoot == uint256S("0x981386fe78795cb9723c6536735cc843c0c5dd77857cf9b50369cd84300c1382"));
        ...
        vSeeds.emplace_back("seed-a.rӕkcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.rӕkcointools.com");
        vSeeds.emplace_back("dnsseed.rӕkcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 447998, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd926a35d78d5f57cfef9e2211adeb7de8de0678dc1ee54974cd69dc9dc6ffa3a"));
        assert(genesis.hashMerkleRoot == uint256S("0x981386fe78795cb9723c6536735cc843c0c5dd77857cf9b50369cd84300c1382"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.rӕkcointools.com");
        vSeeds.emplace_back("seed-b.rӕkcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5237959e730ecac567b61a80c04de5d8b2c457a96cfc2792faaf39ba60451be3"));
        assert(genesis.hashMerkleRoot == uint256S("0x981386fe78795cb9723c6536735cc843c0c5dd77857cf9b50369cd84300c1382"));
