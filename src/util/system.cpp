...
const char * const BITCOIN_CONF_FILENAME = "rӕkcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "rӕkcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/rӕkcoin";
#else
    // Unix
    return pathRet / ".rӕkcoin";
#endif
#endif
}
