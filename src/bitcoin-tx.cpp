...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " rӕkcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  rӕkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded rӕkcoin transaction\n" +
            "or:     rӕkcoin-tx [options] -create [commands]   Create hex-encoded rӕkcoin transaction\n" +
            "\n";
