...
"""Verify that starting rӕkcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rӕkcoin with -h for help text")
        ...
        self.log.info("Start rӕkcoin with -version for version information")
        ...
        self.log.info("Start rӕkcoind with -fakearg to make sure it does not start")
