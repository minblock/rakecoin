# Support for Output Descriptors in rӕkcoin Core

Since rӕkcoin Core v0.17, there is support for Output Descriptors. This is a
...
on rӕkcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing rӕkcoin Core wallets, a convenience function `combo` is
